...
<body>
    ...
    <div class="container" align="center">
		<div class="col-md-4 col-md-offset-4">
			<h3 class="form-signin-heading">판매 물품 ID와 갯수를 입력하시오.</h3>
			<form action="finishSellItem" method="post">
				...
				<button class="btn btn btn-lg btn-success btn-block" type="submit">판매하기</button>
			</form>
		</div>
	</div>
</body>
